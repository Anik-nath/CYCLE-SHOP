...
const ReviewCard = (props) => {
  ...
  return (
    <div className="p-4 text-center bg-white md:w-1/2 mx-auto">
      <div className="testimonial p-4 rounded border-2 border-solid flex  transition-colors duration-300">
