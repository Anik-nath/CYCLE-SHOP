      ...
      <div className="container mx-auto px-6 md:px-4">
        <div className="grid md:grid-cols-2 grid-cols-1 gap-4 md:-mt-16 mt-0">
          <div className="shadow-lg bg-white p-4 flex flex-col justify-center items-center gap-y-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-700">Talk to Sales</h2>
          ...
          <div className="shadow-lg bg-white p-4 flex flex-col justify-center items-center gap-y-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-700">Contact Customer Support</h2>
            <p className="w-1/2 mx-auto text-justify">
        ...
        <div className="py-8" id="office">
            <h2 className="text-3xl font-semibold text-center py-8 mt-8 text-gray-700 capitalize">how to find office</h2>
            <div className="grid md:grid-cols-2 grid-cols-1 gap-4 bg-gray-100 pb-4 md:pb-0">
                <div className="w-full">
                    <img className="w-full" src="https://i.ibb.co/pv3mHnR/singapore.jpg" alt="office" />
                </div>
                ...
                <div className="text-center md:text-left">
                    ...
                    <div className="flex flex-col gap-y-2 my-4">
                        ...
                        <p className="w-2/4 md:text-justify text-lg mx-auto md:mx-0">1 Harbour Pl, Suite 175Portsmouth, NH 03801 Bangladesh</p>
                    </div>
        ...
        <div className="pb-8" id="global">
          <h2 className="text-3xl font-semibold text-center text-gray-700 py-8 mt-8 capitalize">Connect with one of our global offices</h2>
          {/* contact + map */}
          <section className="text-gray-600 body-font relative">
            ...
            <div className="container px-5 py-24 mx-auto flex">
              <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-1 shadow-lg">
